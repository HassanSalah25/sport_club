                    ...
                    <div class="col-lg-10">
                        <div class="card" style="zoom: 1;">
                            <div class="card-header">
                                <h4 class="card-title" id="bordered-layout-card-center">اضافة دور جديد</h4>
                                <a href="/sat/courses/create.php" class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                            </div>
                            <div class="card-content collpase show">
                                <div class="card-body">

                                    <form class="form" action="{{route('role.store')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @include('Dashboard.includes.alerts.errors')
                                        <div class="row m-3">
                                            <div class="form-group">
                                                <label for="projectinput1">اسم الدور</label>
                                                <input type="text" id="projectinput1" class="form-control" required placeholder="ادخل الاسم" name="name" value="{{old('name')}}" />
                                            </div>
                                        </div>
